...
#define IPSKB_FORWARDED		BIT(0) // 数据包是否被转发
#define IPSKB_XFRM_TUNNEL_SIZE	BIT(1) // XFRM隧道大小
#define IPSKB_XFRM_TRANSFORMED	BIT(2) // 数据包是否被XFRM转换
#define IPSKB_FRAG_COMPLETE	BIT(3) // 数据包是否是IP分片
#define IPSKB_REROUTED		BIT(4) // 数据包是否被重新路由
#define IPSKB_DOREDIRECT	BIT(5) // 数据包是否需要重定向
#define IPSKB_FRAG_PMTU		BIT(6) // 分片时使用了路径最大传输单元
#define IPSKB_L3SLAVE		BIT(7) // 数据包是否被L3从设备处理
